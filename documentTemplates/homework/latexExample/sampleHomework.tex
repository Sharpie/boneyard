...
\begin{homeworkSection}[Mass Balance]{}
...
\begin{variables}
  \var{C^{*}_{\mbox{\napl}}}{Is the concentration of the constituent in the \napl\ prior to partitioning.}
\end{variables}

\end{homeworkSection}


\begin{homeworkSection}[Air Phase]{}
...
\begin{variables}
  \var{\mathcal{M}}{Is the molar mass of the constituent.}
  \var{H_{g}}{Is the Henry's Law constant for the constituent.}
\end{variables}
